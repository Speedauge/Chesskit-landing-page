...
import { Github, MessageCircle, Zap, Shield, Heart, Upload, BarChart3, Eye, Users, Star } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "Chesskit - Free Chess Game Analysis | Analyze Chess.com & Lichess Games",
  description:
  ...
  twitter: {
    ...
    title: "Chesskit - Free Chess Game Analysis",
    description: "Analyze your chess games for free. Support for Chess.com, Lichess, and PGN files.",
  },
  robots: {
    index: true,
    follow: true,
    ...
    <div className="min-h-screen bg-[#121212] text-white">
      ...
      <header className="border-b border-[#2e2e30] bg-[#121212]/95 backdrop-blur supports-[backdrop-filter]:bg-[#121212]/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <img src="/chesskit-icon.png" alt="Chesskit Icon" className="w-8 h-8" />
            <span className="text-xl font-bold">Chesskit</span>
          </div>
          <nav className="hidden md:flex items-center space-x-6">
            <Link href="#features" className="text-gray-300 hover:text-[#3b9ac6] transition-colors">
              Features
            </Link>
            <Link href="#how-it-works" className="text-gray-300 hover:text-[#3b9ac6] transition-colors">
              How It Works
            </Link>
            <Link href="#community" className="text-gray-300 hover:text-[#3b9ac6] transition-colors">
              Community
            </Link>
      ...
      <main>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center max-w-4xl">
            <div className="flex justify-center mb-6">
              <Badge variant="secondary" className="bg-[#2e2e30] text-[#3b9ac6] border-[#3b9ac6]/20">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Get deep insights into your chess games with our free, open-source analysis platform. Support for{" "}
              <Link
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="bg-[#3b9ac6] hover:bg-[#3b9ac6]/90 text-white px-8 py-3 text-lg">
              ...
              <Button
                ...
                asChild
              >
                <Link href="https://github.com/GuillaumeSD/Chesskit" target="_blank" rel="noopener noreferrer">
          ...
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Built by chess players, for chess players. Every feature designed to help you improve your game.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="bg-[#2e2e30] border-[#2e2e30] hover:border-[#3b9ac6]/50 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-white">Lightning Fast Analysis</CardTitle>
              ...
              <Card className="bg-[#2e2e30] border-[#2e2e30] hover:border-[#3b9ac6]/50 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-white">Multiple Platforms</CardTitle>
                  <CardDescription className="text-gray-400">
                    Import games from{" "}
                    <Link
                      href="https://www.chess.com"
              ...
              <Card className="bg-[#2e2e30] border-[#2e2e30] hover:border-[#3b9ac6]/50 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-400">
                    Your data stays yours. We don't collect personal information beyond basic monitoring.
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="bg-[#2e2e30] border-[#2e2e30] hover:border-[#3b9ac6]/50 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-400">
                    Completely free forever. No subscriptions, no premium tiers, no surprise charges.
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="bg-[#2e2e30] border-[#2e2e30] hover:border-[#3b9ac6]/50 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-400">
                    Transparent, community-driven development. Contribute, suggest features, or fork the project.
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="bg-[#2e2e30] border-[#2e2e30] hover:border-[#3b9ac6]/50 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-white">Ad-Free Experience</CardTitle>
                  <CardDescription className="text-gray-400">
                    Focus on improving your chess without distractions. Clean, minimal interface.
                  </CardDescription>
                </CardHeader>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  ...
                  engine analyzes every move, highlighting mistakes and missed opportunities.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-[#3b9ac6] rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">
                ...
                <h3 className="text-xl font-semibold mb-4">Improve Your Game</h3>
                <p className="text-gray-400">
                  Study the suggestions and learn from your mistakes to become a stronger player.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="community" className="py-20 px-4 bg-[#2e2e30]/20">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Connect with fellow chess enthusiasts, contribute to the project, and help shape the future of Chesskit.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <Button size="lg" className="bg-[#3b9ac6] hover:bg-[#3b9ac6]/90 px-8 py-3" asChild>
                <Link href="https://discord.gg/NAtPPqZpFN" target="_blank" rel="noopener noreferrer">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
              <Card className="bg-[#2e2e30] border-[#2e2e30]">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-white">Open Source</CardTitle>
                  <CardDescription className="text-gray-400">
                    Contribute code, report bugs, or suggest new features on our GitHub repository.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card className="bg-[#2e2e30] border-[#2e2e30]">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-gray-400">
                    Get help, share tips, and discuss chess strategy with our friendly community.
                  </CardDescription>
                </CardHeader>
              </Card>
            </div>
        ...
        <section id="get-started" className="py-20 px-4">
          <div className="container mx-auto text-center">
            <h2 className="text-4xl font-bold mb-4">Ready to Improve Your Chess?</h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Start analyzing your games today. No signup required, completely free forever.
            </p>
            <Button size="lg" className="bg-[#3b9ac6] hover:bg-[#3b9ac6]/90 text-white px-12 py-4 text-lg">
      ...
      <footer className="border-t border-[#2e2e30] py-12 px-4">
        <div className="container mx-auto">
          ...
          <div className="mt-8 pt-8 border-t border-[#2e2e30] text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Chesskit. Open source and free forever.</p>
            <p className="mt-2 text-sm">No data collection beyond monitoring. Your privacy is our priority.</p>
